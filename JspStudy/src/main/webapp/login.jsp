...
<body>
    <div class="container">
        <header class="d-flex mt-5 ms-auto me-auto">
            <a class="navbar-brand ms-auto me-auto logo_size" href="#"><i class="fab fa-js"></i> web_study</a>
        </header>
        <main class="mt-5">
    ...
    <script src="https://kit.fontawesome.com/98df8cd833.js" crossorigin="anonymous"></script>
